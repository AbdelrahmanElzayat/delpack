          ...
          <div className="faqsCards flex items-center flex-wrap lg:flex-nowrap gap-6">
            {faqsData.map((faq) => (
              <motion.div
                ...
                } justify-center items-center flex-wrap gap-4 py-4 px-6 pt-6 pb-0 cursor-pointer transition-all overflow-hidden`}
                style={{
              ...
              >
                <div className="our flex flex-col gap-2">
                  <motion.span
                    className="text-[#f7941d] text-lg sm:text-xl md:text-2xl lg:text-4xl xl:text-7xl transition-all"
                    initial="hidden"
                    animate={open === faq.id ? "visible" : "hidden"}
                    variants={contentVariants}
                  >
